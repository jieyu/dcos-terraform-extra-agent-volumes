...
module "dcos-bootstrap-install" {
  source  = "../../null/dcos-install-bootstrap-remote-exec"
  version = "~> 0.1.0"
...
module "dcos-masters-install" {
  source  = "../../null/dcos-install-masters-remote-exec"
  version = "~> 0.1.0"
...
module "dcos-private-agents-install" {
  source  = "../../null/dcos-install-private-agents-remote-exec"
  version = "~> 0.1.0"
...
module "dcos-public-agents-install" {
  source  = "../../null/dcos-install-public-agents-remote-exec"
  version = "~> 0.1.0"
