...
module "dcos-infrastructure" {
  ...
  private_agents_num_extra_volumes           = "${var.private_agents_num_extra_volumes}"
  private_agents_extra_volume_sizes          = ["${var.private_agents_extra_volume_sizes}"]
  private_agents_extra_volume_types          = ["${var.private_agents_extra_volume_types}"]
  private_agents_extra_volume_iopses         = ["${var.private_agents_extra_volume_iopses}"]
...
module "dcos-install" {
  source  = "../../null/dcos-install-remote-exec"
  version = "~> 0.0.0"
