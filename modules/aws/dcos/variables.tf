...
variable "private_agents_num_extra_volumes" {
  description = "[PRIVATE AGENTS] Number of extra volumes"
  default     = "0"
}

variable "private_agents_extra_volume_sizes" {
  description = "[PRIVATE AGENTS] Volume sizes in GB for extra volumes"
  default     = ["120"]
}

variable "private_agents_extra_volume_types" {
  description = "[PRIVATE AGENTS] Volume types for extra volumes"
  default     = [""]
}

variable "private_agents_extra_volume_iopses" {
  description = "[PRIVATE AGENTS] Volume iopses for extra volumes"
  default     = ["0"]
}
