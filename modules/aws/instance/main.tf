...
module "extra-volumes" {
  ...
  num_instances = "${var.num}"
  num           = "${var.num_extra_volumes}"
  sizes         = ["${var.extra_volume_sizes}"]
  types         = ["${var.extra_volume_types}"]
  iopses        = ["${var.extra_volume_iopses}"]
